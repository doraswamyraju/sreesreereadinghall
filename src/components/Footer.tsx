...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-slate-950 border-t border-rose-900/40 text-slate-400 py-12 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-xl overflow-hidden border border-rose-500/40 bg-rose-950 flex items-center justify-center">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li><a href="#facilities" className="hover:text-rose-400 transition-colors">Premium Facilities</a></li>
              <li><a href="#seats" className="hover:text-rose-400 transition-colors">Visual Seat Map</a></li>
              <li><a href="#pricing" className="hover:text-rose-400 transition-colors">Pricing & Plans</a></li>
              <li><a href="#gallery" className="hover:text-rose-400 transition-colors">Real Photo Tour</a></li>
              <li><a href="#blog" className="hover:text-rose-400 transition-colors">Exam Study Blogs</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-xs">
              <a href="tel:+919666152456" className="flex items-center space-x-2 text-rose-400 hover:underline font-bold">
                <Phone className="w-4 h-4" />
                <span>+91 9666152456</span>
              </a>
              <a href="mailto:info@sreesreeservices.in" className="flex items-center space-x-2 hover:text-rose-400">
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-rose-900/30 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-400 gap-4">
          <p>© {new Date().getFullYear()} Sree Sree Reading Hall (Sree Sree Services). All rights reserved.</p>
          
          <button
            onClick={scrollToTop}
            className="flex items-center space-x-1.5 px-3 py-1.5 rounded-xl bg-rose-950 border border-rose-500/30 text-rose-300 hover:bg-rose-900 text-xs"
          >
