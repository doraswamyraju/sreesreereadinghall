...
export const BookingModal: React.FC<BookingModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in">
      <div className="relative max-w-lg w-full glass-card border border-emerald-500/40 rounded-3xl overflow-hidden bg-slate-900 shadow-2xl">
        
        {/* Header */}
        <div className="p-6 bg-slate-950 border-b border-emerald-900/40 flex items-center justify-between">
        ...
        {step === 'form' ? (
          <form onSubmit={handleConfirm} className="p-6 space-y-4">
            ...
            <div className="bg-emerald-950/40 border border-emerald-500/30 p-4 rounded-2xl flex items-center justify-between">
              <div>
                <span className="text-[10px] text-emerald-400 font-bold uppercase tracking-wider">Reserved Seat</span>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 rounded-xl bg-slate-950 border border-emerald-500/30 text-white text-xs placeholder-slate-500 focus:outline-none focus:border-emerald-400"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2 rounded-xl bg-slate-950 border border-emerald-500/30 text-white text-xs focus:outline-none focus:border-emerald-400"
                >
            ...
            <div className="pt-2">
              <button
                type="submit"
                className="w-full py-3.5 rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-400 text-slate-950 font-black text-xs uppercase tracking-wider shadow-lg shadow-emerald-500/30 hover:brightness-110 transition-all flex items-center justify-center space-x-2"
              >
          ...
          <div className="p-8 text-center space-y-4">
            ...
            <p className="text-xs text-slate-300">
              Desk <strong className="text-emerald-400 font-mono text-sm">{seatNumber}</strong> has been provisionally reserved for <strong className="text-white">{formData.fullName}</strong>.
            </p>
            <div className="bg-slate-950 border border-emerald-500/20 p-3 rounded-xl text-left text-xs text-slate-300 space-y-1 font-mono">
            ...
            <button
              ...
              className="w-full py-3 bg-emerald-500 text-slate-950 font-extrabold text-xs rounded-xl uppercase tracking-wider"
            >
